...
export default function Hero() {
  ...
  return (
    <div>
      ...
      >
        {/* Main Heading */}
        <div className="container mx-auto relative z-10 text-center mt-auto">
          {" "}
          {/* Added mt-auto */}
          <h1
        ...
        {/* Content Section */}
        <div className="flex flex-col sm:flex-row sm:justify-between w-full relative z-10 items-center space-y-5 sm:space-y-0 sm:px-6 mt-auto">
          {" "}
          {/* Added mt-auto */}
          {/* Left Column */}
          <div className="flex flex-col space-y-3 sm:space-y-5 sm:w-1/2 w-full justify-center items-center sm:items-start text-center sm:text-left">
            ...
            <div className="text-2xl sm:text-4xl md:text-6xl font-bold">
              ...
              <Fade direction="up" triggerOnce>
                {" "}
                <p className="sm:hidden  text-white">
                  Hey There, I’m Khadi
                </p>{" "}
              </Fade>{" "}
              {/* Mobile view */}
          ...
          <div className="flex sm:w-1/2 justify-center sm:justify-end w-full">
            <div className="w-full sm:max-w-md text-sm sm:text-xs">
              {/* For small screens */}
              <p className="text-center sm:text-left sm:hidden  text-white">
                <Typewriter
                  words={[
