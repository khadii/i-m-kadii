    ...
    <div className="relative w-full ">
      ...
      >
        <div className="w-full md:w-[40%] flex flex-col space-y-6 sm:space-y-10">
          ...
          <p className="text-[#3A3A3A] text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold">
      ...
      <div className="bg-white flex justify-center p-6 md:p-10 pb-14">
        ...
        <AttentionSeeker
                  ...
                  >
           <div>
           <Link href="/cv_template.pdf" target="_blank" className="flex items-center space-x-2 sm:space-x-4">
              <div className="flex justify-center w-full space-x-2 sm:space-x-3">
                <span>Download CV</span>
                <DownloadIcon className="w-5 h-5 sm:w-6 sm:h-6" color="#F1875E" />
              </div>
            </Link>
           </div>
          </AttentionSeeker>
